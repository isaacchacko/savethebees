          ...
          <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-8">
            ...
            >
              ...
              >
                ...
                <div className="absolute inset-0 bg-(--primary-color) rounded-lg flex items-center justify-center backface-hidden rotate-y-180">
