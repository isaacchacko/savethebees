...
const BASE_CLASS_NAME = "transition-transform duration-200 ease-in-out transform scale-90 hover:scale-100 hover:drop-shadow-[0_0_15px_rgba(255,255,255,0.6)]";
